...
import { StyleSheet, Text, View, ScrollView, KeyboardAvoidingView, TextInput, Pressable, Image, PermissionsAndroid } from 'react-native'
...
const ChatMessageScreen = () => {
    ...
    const imagePicker = async () => {
        ...
        try {
            ...
            // console.log("Yeh Result aa rha ahai if ke bad >>>>>>>>>>>>>>>>>", result.assets[0].uri);
    ...
    // console.log("Yeh messages wala hai >>>>>>>>>>>>>>>>>>>>>", selectedMessages);
    ...
    return (
        <KeyboardAvoidingView style={{ flex: 1, backgroundColor: "#F0F0F0" }}>
            <ScrollView ref={scrollViewRef} contentContainerStyle={{ flexGrow: 1 }} onContentSizeChange={handleContentSizeChange}>
                {
                    messages.map((item, index) => {
                        if (item.messageType === "text") {
                            ...
                            return (
                                <Pressable onLongPress={() => handleSelectMessage(item)} key={index} style={[
                                    ...
                                    <Text style={{
                                        fontSize: 13, fontWeight: 'bold', textAlign: isSelected ? "right" : "left"
                                    }}>{item?.message}</Text>
                        ...
                        if (item.messageType === "image") {
                            const baseUrl = "G:\\Projects\\Mobile-Chat-App\\Kartik_Messenger\\api\\files";
            ...
            <View style={{ flexDirection: 'row', alignItems: "center", paddingHorizontal: 10, paddingVertical: 10, borderWidth: 1, borderTopColor: '#dddddd', marginBottom: showEmojiSelector ? 0 : 25 }}>
